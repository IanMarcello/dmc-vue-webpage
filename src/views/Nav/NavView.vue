    ...
    <div class="bg-[#16191f] flex items-center">
      <div>
        <router-link
          :to="{ name: '' }"
          v-scroll-to="'#about'"
          class="px-3 text-base font-medium border border-transparent rounded-md cursor-pointer transition-colors hover:text-red-600"
          >About</router-link
        >
      </div>
      <div>
